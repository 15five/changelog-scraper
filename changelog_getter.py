...
def print_urls(token, output_dir=None):
    for url in f:
        ...
        url = '/'.join(seperated_url[:5])  # we don't care about anything after repo name
        ...
        if verbosity > 0: print("searching through files: " + str(root_file_names))
...
if __name__ == "__main__":
    ...
    parser.add_argument('-o', '--outputdirectory', help='If specified downloads changelogs to this dir in the form dir/owner/repo/CHANGELOG.md', type=str)
